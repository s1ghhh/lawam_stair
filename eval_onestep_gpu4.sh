#!/usr/bin/env bash
# =============================================================================
# cmp4 评测 | 变体 = onestep | GPU 4 | libero_10 (10 task) x 10 trial
# 内部串行三口径: std5_exec10 / fast_exec10 / fast_exec50 (对比协议, 各 100 ep)
#   只想跑主口径 -> SKIP_MODES="fast_exec10 fast_exec50" bash eval_onestep_gpu4.sh
# 用法:
#   bash eval_onestep_gpu4.sh                                     # 自动找正式 ckpt
#   CKPT=/abs/.../final_model/pytorch_model.pt bash eval_onestep_gpu4.sh   # 显式指定
# =============================================================================
set -euo pipefail
