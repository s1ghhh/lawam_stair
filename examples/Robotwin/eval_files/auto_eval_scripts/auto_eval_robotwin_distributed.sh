...
DEFAULT_CKPT="${DEFAULT_CKPT:-results/Checkpoints/robotwin/0513_092227+robotwin_b1024rp2_80k_sec12_30hz_aug/final_model/pytorch_model.pt}"
...
export ROBOTWIN_WAIT_FOR_SCHEDULER=0.1
